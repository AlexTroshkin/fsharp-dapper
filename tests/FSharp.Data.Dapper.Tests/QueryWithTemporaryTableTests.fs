    ...
    testList "Query with temp table tests" [
        ...
        yield! testFixture ``connection with filled person table`` [
            ...
            fun connection ->
                ...
                let script = "select * from Persons as p inner join PersonIdentificators as pi on p.Id = pi.Id"
        ...
        yield! testFixture ``with connection`` [
            ...
            fun connection ->
                ...
                let script = "select * from TPersons"
                let tempTable = ``Temp table``("TPersons", persons)
